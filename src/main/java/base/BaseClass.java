...
public class BaseClass {
    ...
    public static void toClick(WebElement wb) {
        wb.click();
    }

    public static void tofillText(WebElement wb,String s) throws InterruptedException {
        for(char c:s.toCharArray()) {
            wb.sendKeys(Character.toString(c));
            Thread.sleep(100);
        }
    ...
    public static void select(WebElement wb,String str){
        sel = new Select(wb);
